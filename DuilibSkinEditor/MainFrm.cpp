...
BOOL CMainFrame::CreateDockingWindows()
{
	...
	bNameValid = strPreviewWnd.LoadString(IDS_PREVIEW_WND);
	ASSERT(bNameValid);
	if (!m_wndPreView.Create(strPreviewWnd, this, CRect(0, 0, 200, 200), TRUE, 400, WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | CBRS_RIGHT | CBRS_FLOAT_MULTI))
	{
		TRACE0("未能创建“预览”窗口\n");
		return FALSE; // 未能创建
	}
